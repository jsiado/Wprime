...
C     
C     Process: u d~ > rho+ t23 > b~ w+ b g C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @3
C     Process: c s~ > rho+ t23 > b~ w+ b g C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     
      ...
      DATA (NHEL(I,  17),I=1,6) / 1,-1,-1, 0,-1,-1/
      DATA (NHEL(I,  18),I=1,6) / 1,-1,-1, 0,-1, 1/
      DATA (NHEL(I,  19),I=1,6) / 1,-1,-1, 0, 1,-1/
      DATA (NHEL(I,  20),I=1,6) / 1,-1,-1, 0, 1, 1/
      ...
      DATA (NHEL(I,  53),I=1,6) /-1,-1, 1, 0,-1,-1/
      DATA (NHEL(I,  54),I=1,6) /-1,-1, 1, 0,-1, 1/
      DATA (NHEL(I,  55),I=1,6) /-1,-1, 1, 0, 1,-1/
      DATA (NHEL(I,  56),I=1,6) /-1,-1, 1, 0, 1, 1/
      ...
      DATA (NHEL(I,  89),I=1,6) /-1, 1,-1, 0,-1,-1/
      DATA (NHEL(I,  90),I=1,6) /-1, 1,-1, 0,-1, 1/
      DATA (NHEL(I,  91),I=1,6) /-1, 1,-1, 0, 1,-1/
      DATA (NHEL(I,  92),I=1,6) /-1, 1,-1, 0, 1, 1/
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,7))
      CALL FFV1_2(W(1,3),W(1,6),GC_7,MDL_MB,ZERO,W(1,8))
      CALL FFV2_1(W(1,5),W(1,4),GC_64,MDL_MT23,MDL_WT23,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,8),W(1,9),W(1,7),GC_44,AMP(1))
      CALL FFV1_1(W(1,5),W(1,6),GC_7,MDL_MB,ZERO,W(1,8))
      CALL FFV2_2(W(1,3),W(1,7),GC_44,MDL_MT23,MDL_WT23,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,5),W(1,8),W(1,4),GC_64,AMP(2))
      CALL FFV1_2(W(1,1),W(1,6),GC_7,ZERO,ZERO,W(1,5))
      CALL FFV2_3(W(1,5),W(1,2),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,9),W(1,8),GC_44,AMP(3))
      CALL FFV1_1(W(1,2),W(1,6),GC_7,ZERO,ZERO,W(1,8))
      CALL FFV2_3(W(1,1),W(1,8),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,3),W(1,9),W(1,6),GC_44,AMP(4))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=+AMP(1)+AMP(2)
      JAMP(2,1)=+AMP(3)+AMP(4)
