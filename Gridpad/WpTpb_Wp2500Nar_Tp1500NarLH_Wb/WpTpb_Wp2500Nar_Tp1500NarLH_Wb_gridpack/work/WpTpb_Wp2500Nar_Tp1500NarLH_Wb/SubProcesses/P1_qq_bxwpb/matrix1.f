...
C     
C     Process: u d~ > rho+ t23 > b~ w+ b C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @1
C     Process: c s~ > rho+ t23 > b~ w+ b C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     
      ...
      DATA (NHEL(I,  27),I=1,5) /-1,-1, 1, 0,-1/
      DATA (NHEL(I,  28),I=1,5) /-1,-1, 1, 0, 1/
      ...
      DATA (NHEL(I,  45),I=1,5) /-1, 1,-1, 0,-1/
      DATA (NHEL(I,  46),I=1,5) /-1, 1,-1, 0, 1/
...
C     ----------
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,6))
      CALL FFV2_1(W(1,5),W(1,4),GC_64,MDL_MT23,MDL_WT23,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,2),W(1,6),GC_44,AMP(1))
