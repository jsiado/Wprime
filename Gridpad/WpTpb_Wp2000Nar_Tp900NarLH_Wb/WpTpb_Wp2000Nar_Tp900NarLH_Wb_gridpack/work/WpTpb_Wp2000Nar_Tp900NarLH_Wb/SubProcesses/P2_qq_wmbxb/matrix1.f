...
C     
C     Process: d u~ > rho- t23~ > w- b~ b C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @2
C     Process: s c~ > rho- t23~ > w- b~ b C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_2(W(1,4),W(1,3),GC_64,MDL_MT23,MDL_WT23,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,5),W(1,6),GC_44,AMP(1))
