...
C     
C     Process: g d~ > rho+ t23 > b~ w+ b u~ C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @3
C     Process: g s~ > rho+ t23 > b~ w+ b c~ C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_1(W(1,5),W(1,4),GC_64,MDL_MT23,MDL_WT23,W(1,8))
      CALL FFV2_3(W(1,6),W(1,7),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,8),W(1,5),GC_44,AMP(1))
      CALL FFV1_2(W(1,6),W(1,1),GC_7,ZERO,ZERO,W(1,5))
      CALL FFV2_3(W(1,5),W(1,2),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,3),W(1,8),W(1,6),GC_44,AMP(2))
