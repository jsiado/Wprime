...
C     
C     Process: g u > rho+ t23 > b~ w+ b d C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @3
C     Process: g c > rho+ t23 > b~ w+ b s C2R=2 WEIGHTED=8 CRV=2 CRT=2
C      CRF=2 CTP=2 @3
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_3(W(1,7),W(1,6),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,8),W(1,5),GC_44,AMP(1))
      CALL FFV1_1(W(1,6),W(1,1),GC_7,ZERO,ZERO,W(1,5))
      CALL FFV2_3(W(1,2),W(1,5),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,6))
