...
C     
C     Process: d u~ > rho- t23~ > w- b~ b g C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @4
C     Process: s c~ > rho- t23~ > w- b~ b g C2R=2 WEIGHTED=8 CRV=2
C      CRT=2 CRF=2 CTP=2 @4
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
      ...
      CALL FFV2_2(W(1,4),W(1,3),GC_64,MDL_MT23,MDL_WT23,W(1,8))
      CALL FFV1_1(W(1,5),W(1,6),GC_7,MDL_MB,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,8),W(1,9),W(1,7),GC_44,AMP(1))
      CALL FFV1_2(W(1,4),W(1,6),GC_7,MDL_MB,ZERO,W(1,9))
      CALL FFV2_1(W(1,5),W(1,7),GC_44,MDL_MT23,MDL_WT23,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,9),W(1,4),W(1,3),GC_64,AMP(2))
      CALL FFV1_2(W(1,1),W(1,6),GC_7,ZERO,ZERO,W(1,4))
      CALL FFV2_3(W(1,4),W(1,2),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,8),W(1,5),W(1,9),GC_44,AMP(3))
      CALL FFV1_1(W(1,2),W(1,6),GC_7,ZERO,ZERO,W(1,9))
      CALL FFV2_3(W(1,1),W(1,9),GC_49,MDL_MRHOP,MDL_WRHOP,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,8),W(1,5),W(1,6),GC_44,AMP(4))
